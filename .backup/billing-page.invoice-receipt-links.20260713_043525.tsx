...
const BILLING_LIST_ENDPOINT = "/billing/summary";
    ...
    <main className="space-y-6 p-6">
      <div>
        ...
        <p className="mt-1 text-sm text-slate-500">
          청구서별 청구 금액, 납부 금액, 미납 금액과 결제 상태를 확인하고 수동 결제를 등록합니다.
        </p>
      </div>
        ...
        <table className="w-full min-w-[1420px] text-left text-sm">
          <thead className="bg-slate-50 text-center text-slate-600">
            <tr>
              ...
              <th className="whitespace-nowrap px-4 py-3 text-center">납부 금액</th>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-950/60 p-4">
          <div className="w-full max-w-3xl rounded-3xl bg-white p-6 shadow-2xl">
            ...
            <div className="grid gap-3 text-sm md:grid-cols-2">
              ...
              <DetailItem label="납부 금액" value={formatCurrency(getPaidAmount(selectedDetailItem))} />
